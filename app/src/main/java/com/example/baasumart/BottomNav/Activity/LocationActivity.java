...
public class LocationActivity extends AppCompatActivity implements OnMapReadyCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(country.isEmpty()||city.isEmpty()||fullAddress.isEmpty()||state.isEmpty()){
                    Toast.makeText(LocationActivity.this, "Wait", Toast.LENGTH_SHORT).show();
                }else{
                    Intent intent = new Intent(LocationActivity.this, PurchaseProductActivity.class);
                    ...
                    intent.putExtra("longtitude",longitute);
